<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="string[@id='str_culture_description.byzantine']"/>
    <xsl:template match="string[@id='str_culture_description.sturgia']"/>
	<xsl:template match="string[@id='str_culture_description.ayyubid']"/>
	...
	<xsl:template match="string[@id='str_culture_rich_name.byzantine']"/>
    <xsl:template match="string[@id='str_culture_rich_name.sturgia']"/>
	<xsl:template match="string[@id='str_culture_rich_name.ayyubid']"/>
